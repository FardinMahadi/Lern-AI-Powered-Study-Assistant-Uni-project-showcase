...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navWidth = desktopWidth;

  const contextValue = useMemo<DashboardLayoutContextValue>(
    () => ({
      sidebarVisible: true, // Always visible, only collapsed/expanded
      collapsed,
      showSidebar: toggleCollapse, // Toggle collapse instead
      hideSidebar: toggleCollapse, // Toggle collapse instead
      setCollapsed,
      toggleCollapse,
    }),
